...
3. 제3자 서비스
앱은 날씨 데이터를 위해 기상청 단기예보 API 및 OpenWeatherMap API를, 배경 이미지를 위해 Unsplash API를 사용합니다. 위치 정보는 날씨 조회 목적으로만 각 서비스에 일시 전달되며, 별도로 저장되지 않습니다. 각 서비스의 개인정보처리방침을 참고하세요.
